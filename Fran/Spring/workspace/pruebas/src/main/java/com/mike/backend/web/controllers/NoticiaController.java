...
import com.mike.backend.web.entidades.dto.NoticiasDto;
...
public class NoticiaController {
	...
	public Map<String,Object>getNoticias() {
		...
		resp.put("noticias", noticiaService.findAll().stream().map(e -> NoticiasDto.fromEntity(e)).collect(Collectors.toList()));
		return resp;
	}
