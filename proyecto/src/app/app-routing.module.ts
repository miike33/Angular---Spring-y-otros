...
const routes: Routes = [
  ...
  {
    path: 'details',
    loadChildren: () => import('./details-noticia/details.module').then( m => m.DetailsPageModule)
  },
  {
    path: 'add-noticia',
    loadChildren: () => import('./add-noticia/add-noticia.module').then( m => m.AddNoticiaPageModule)
  },
  {
    path: 'list-users',
